public class BlackjackPlayer extends Player {
	...
	public BlackjackPlayer(String n, int s) {
		super(n,s);
	}
	...
	public static void main(String args[])  {
		...
		BlackjackPlayer rod = new BlackjackPlayer("rod",2);
		rod.addCard(ace);
		rod.addCard(king);
		System.out.println("\n" + rod);
		...
		BlackjackPlayer chan = new BlackjackPlayer("chan",3);
		chan.addCard(king);
		chan.addCard(five);
		chan.addCard(six);
		System.out.println("\n" + chan);
		...
		BlackjackPlayer reggie = new BlackjackPlayer("reggie",4);
		reggie.addCard(four);
		reggie.addCard(five);
		reggie.addCard(ace);
		reggie.addCard(ace);
		...
		BlackjackPlayer keisha = new BlackjackPlayer("keisha",4);
		keisha.addCard(six);
		keisha.addCard(five);
		keisha.addCard(ace);
		keisha.addCard(ace);
		...
		BlackjackPlayer aladeen = new BlackjackPlayer("aladeen",4);
